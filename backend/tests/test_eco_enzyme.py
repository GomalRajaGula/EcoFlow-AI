...
class TestEcoEnzymeService:
    ...
    def test_calculate_ingredients_different_weights(self):
        ...
        assert result["ideal_water_liters"] == 15
        assert result["ideal_sugar_kg"] == 5
        
        result = EcoEnzymeService.calculate_ingredients(20)
        assert result["ideal_water_liters"] == 60
        assert result["ideal_sugar_kg"] == 20
    ...
    def test_check_ingredient_deviation_exact_match(self):
        result = EcoEnzymeService.check_ingredient_deviation(10, 30, 10)
    ...
    def test_check_ingredient_deviation_exceeds_threshold(self):
        result = EcoEnzymeService.check_ingredient_deviation(10, 35, 10, threshold=0.1)
    ...
    def test_check_ingredient_deviation_both_exceed(self):
        result = EcoEnzymeService.check_ingredient_deviation(10, 36, 12, threshold=0.1)
    ...
    def test_check_ingredient_deviation_custom_threshold(self):
        result = EcoEnzymeService.check_ingredient_deviation(10, 33, 10, threshold=0.15)
